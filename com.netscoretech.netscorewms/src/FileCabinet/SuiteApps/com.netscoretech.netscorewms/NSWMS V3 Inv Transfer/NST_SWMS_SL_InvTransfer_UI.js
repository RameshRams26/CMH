      ...
      try {
        ...
        urlObj.logIn = utility.getScriptUrl(
         ...
         urlObj.ajaxUrl = utility.getScriptUrl(
          "customscript_nst_wms_invtransfer_be",
          "customdeploy_nst_wms_invtransfer_be"
        );

        var Html,
          filesObj = utility.getFilesInFolder("NSWMS V3 Inv Transfer", true),
          globalFiles = utility.getFilesInFolder("NSWMS V3 Globals", true),
          images = utility.getFilesInFolder("NSWMS V3 Images", true);
        Html = https.get({
          url: filesObj["NST_SWMS_InvTransfer.html"],
        });
        ...
        HtmlDocument = HtmlDocument.replace(
          "customJs",
          filesObj["NST_SWMS_InvTransfer_Assets.js"]
        );
        ...
        log.error("Catch Block Message In nst_wms_SL_InvTransfer_UI::", e);
      }
    };
